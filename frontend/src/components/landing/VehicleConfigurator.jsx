    ...
    <section data-testid="vehicle-configurator" className="py-24 relative">
      <div className="max-w-5xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          ...
          <h2 className="font-['Orbitron'] text-2xl sm:text-3xl font-bold text-white mb-4">Marktwert-Check</h2>
            ...
            {price !== null && (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }}
                ...
                <motion.div key={price} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                  className="font-['Orbitron'] text-xl lg:text-2xl font-bold text-white tracking-tighter mb-3">
