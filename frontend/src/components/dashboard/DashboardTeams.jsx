...
export const DashboardTeams = () => (
  <>
    <div className="mb-8">
      <h1 data-testid="teams-title" className="font-['Orbitron'] text-xl font-bold tracking-tight" style={{ color: t.text }}>Teams</h1>
        ...
        return (
          <motion.div key={role.name} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="font-['Orbitron'] text-xl font-bold" style={{ color: t.text }}>{role.count}</span>
            </div>
    ...
    {/* Members */}
    <h3 className="font-['Orbitron'] text-sm font-bold mb-4" style={{ color: t.text }}>Mitglieder</h3>
