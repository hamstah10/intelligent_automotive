...
export const DashboardTenants = () => (
  <>
    <div className="mb-8">
      <h1 data-testid="tenants-title" className="font-['Space_Grotesk'] text-3xl font-bold tracking-tight" style={{ color: t.text }}>Tenants</h1>
    ...
    <div className={`${surface()} overflow-hidden`}>
      <div className="p-5 pb-0">
        <h3 className="font-['Space_Grotesk'] text-lg font-bold" style={{ color: t.text }}>Alle Mandanten</h3>
