    ...
    <div ref={containerRef} className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="py-32 px-6 bg-[#0A0A0A]">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            <h2 className="font-['Outfit'] text-3xl sm:text-4xl font-bold tracking-tighter text-white mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <AnimatedSection key={index} delay={index * 0.1} className="text-center">
                <div className="font-['Outfit'] text-4xl lg:text-5xl font-bold text-[#CCFF00] tracking-tighter">
                  {stat.value}
                </div>
      ...
      <footer className="py-8 px-6 border-t border-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <p className="text-white/40 text-sm">© 2024 AutoIntel. Tuning Intelligence.</p>
        </div>
      </footer>
    </div>
  );
