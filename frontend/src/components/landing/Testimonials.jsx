      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <motion.h2
            ...
            className="font-['Outfit'] text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tighter text-white"
          >
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              <div className="font-['Outfit'] text-2xl lg:text-3xl font-bold text-white tracking-tighter">
                {stat.value}
              </div>
