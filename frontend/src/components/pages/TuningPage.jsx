      ...
      <section className="py-32 px-6 bg-[#0A0A0A]">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            <h2 className="font-['Syne'] text-3xl sm:text-4xl font-bold tracking-tighter text-white mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <AnimatedSection key={index} delay={index * 0.1} className="text-center">
                <div className="font-['Syne'] text-4xl lg:text-5xl font-bold text-[#CCFF00] tracking-tighter">
                  {stat.value}
                </div>
